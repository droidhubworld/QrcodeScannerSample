...
public final class ScannerView extends ViewGroup {
        ...
        if (attrs == null) {
            ...
            try {
                ...
                setAutoFocusButtonVisible(
                        a.getBoolean(R.styleable.ScannerView_autoFocusButtonVisible,
                                DEFAULT_AUTO_FOCUS_BUTTON_VISIBLE));
                setFlashButtonVisible(a.getBoolean(R.styleable.ScannerView_flashButtonVisible,
                        DEFAULT_FLASH_BUTTON_VISIBLE));
                setAutoFocusButtonColor(a.getColor(R.styleable.ScannerView_autoFocusButtonColor,
                        DEFAULT_AUTO_FOCUS_BUTTON_COLOR));
                setFlashButtonColor(a.getColor(R.styleable.ScannerView_flashButtonColor,
    ...
    public boolean onTouchEvent(MotionEvent event) {
        final Scanner codeScanner = mScanner;
    ...
    void setScanner(@NonNull final Scanner scanner) {
        ...
        mScanner = scanner;
        setAutoFocusEnabled(scanner.isAutoFocusEnabled());
        setFlashEnabled(scanner.isFlashEnabled());
    }
