...
import com.droidhubworld.qrscanner.callback.ErrorCallback;
import com.droidhubworld.qrscanner.exception.CodeScannerException;
import com.droidhubworld.qrscanner.utils.DecodeTask;
import com.droidhubworld.qrscanner.utils.Decoder;
import com.droidhubworld.qrscanner.utils.DecoderWrapper;
import com.droidhubworld.qrscanner.utils.Point;
import com.droidhubworld.qrscanner.utils.Rect;
...
public class Scanner {
    ...
    /**
     * First camera back-facing
     */
    public static final int CAMERA_BACK = -1;

    /**
     * First camera front-facing
     */
     ...
     */
    @MainThread
    public Scanner(@NonNull final Context context, @NonNull final ScannerView view) {
        mContext = context;
        mScannerView = view;
    ...
    private final class ScannerSizeListener implements ScannerView.SizeListener {
        @Override
